...
SELECT * FROM products WHERE name LIKE "RX 460";
...
SELECT * FROM products WHERE name LIKE "v005";

-- Delete User By Id

DELETE from users WHERE id LIKE "004";

-- Delete Product By Id

DELETE from products WHERE id LIKE "v011";
